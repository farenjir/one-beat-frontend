...
export default function ProducerCard({ producer }: { producer: IUser }) {
	...
	return (
		<>
			{/*  [clip-path:polygon(80%_0%,100%_20%,100%_100%,0%_100%,0%_0%)] */}
			<div className="producer-card relative flex flex-col justify-between p-5 pt-[100px] bg-appLightGrey min-h-[350px] max-w-[350px] rounded-xl shadow-xl">
				<Image
